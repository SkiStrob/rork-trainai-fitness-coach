            ...
            VStack(spacing: 16) {
                ZStack {
                    ...
                    GeometryReader { geo in
                        ...
                        ZStack {
                            ...
                            TrainityCurveAreaPath(width: width, height: height)
                                .fill(
                                    LinearGradient(
                            ...
                            TrainityCurvePath(width: width, height: height)
                                .trim(from: 0, to: chartProgress)
                ...
                HStack(spacing: 24) {
                    HStack(spacing: 6) {
                        ...
                        Text("Trainity").font(.caption.bold()).foregroundStyle(.primary)
                    }
                    HStack(spacing: 6) {
                ...
                Text("80% of Trainity users maintain their progress after 6 months")
                    .font(.system(size: 14))
                    .foregroundStyle(.secondary)
...
struct TrainityCurvePath: Shape {
    let width: CGFloat
    let height: CGFloat
...
struct TrainityCurveAreaPath: Shape {
    let width: CGFloat
    let height: CGFloat
    nonisolated func path(in rect: CGRect) -> Path {
        var path = Path()
