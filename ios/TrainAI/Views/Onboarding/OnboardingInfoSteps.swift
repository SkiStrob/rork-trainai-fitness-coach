...
struct RealisticTargetStepView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("90% of users say the change is obvious after using Trainity and it is not easy to plateau.")
                .font(.system(size: 14))
                .foregroundStyle(.secondary)
...
struct DarkComparisonStepView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            VStack(alignment: .leading, spacing: 8) {
                Text("Gain twice as much with Trainity vs on your own")
                    .font(.system(size: 28, weight: .bold))
                    .foregroundStyle(.primary)
                    .padding(.top, 24)
            }
            ...
            (Text("Trainity makes it easy and holds ").foregroundStyle(.primary) + Text("you accountable.").foregroundStyle(.secondary))
                .font(.subheadline)
                .multilineTextAlignment(.center)
                .padding(.horizontal, 40)
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                Text("Based on Trainity's analysis, physique changes are subtle at first, but after 7 days you can see real differences!")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
            .padding(20)
...
struct ThankYouStepView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("Now let's personalize Trainity for you...")
                .font(.subheadline)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
